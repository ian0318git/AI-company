...
/**
 * @brief StackChan display implementation using M5GFX (SSD1306 128x64)
 *
 * SSD1306 on I2C (SDA=21, SCL=22, addr=0x3C)
 */
class DisplaySSD1306 : public IDisplay {
public:
    DisplaySSD1306() : _initialized(false) {}
    ...
    int width() const override { return _initialized ? _lcd.width() : 128; }
    int height() const override { return _initialized ? _lcd.height() : 64; }
